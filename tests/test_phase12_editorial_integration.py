...
def _inputs():
    ...
    direction = audio.data()["chapter_directions"][0]
    return snapshot, request, sequence, catalog, selection, caps, audio, (str(direction["chapter_audio_direction_id"]), str(direction["chapter_audio_direction_hash"]))

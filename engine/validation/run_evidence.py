...
def _reference(value: Mapping[str, object], *, run_id: str) -> EvidenceReference:
    ...
    if (item.schema_version != REFERENCE_V1 or item.kind not in {"render_receipt", "artifact_registry", "storage_admission", "domain_snapshot", "source_capture", "source_audio_direction", "artifact_integrity", "narration_safety", "audio_boundary", "failure_code"}

...
Make a bounded implementation authorization decision for the accepted Phase 15
`EvidenceAttachmentValidator` contract. It may attach only canonical Phase 4
receipt/props, Phase 14 registry/admission and Domain Pack snapshot evidence;
do not add live transport, retry, queue/worker, media validation, Studio/UI,

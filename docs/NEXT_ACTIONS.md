...
Implement only the bounded cache-plan execution package authorized by
`baseline/phase14_cache_plan_execution_implementation_authorization.md`, then
run focused tests and request one independent implementation audit. Do not

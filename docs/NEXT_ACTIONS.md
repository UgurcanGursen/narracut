...
Repair only `P14-MRI-001` in
`docs/specifications/phase14_master_repair_integration_contract.md`, then
request a targeted re-audit. Do not implement permanent deletion, automatic
